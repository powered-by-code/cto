...
export default function ServicePage({ params }: { params: { id: string } }) {
  ...
  const otherServices = serviceDetails.filter(s => s.id !== service.id).slice(0, 2);
    ...
    <PageLayout>
      ...
      <section className="bg-base-200 py-16 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center">
            <div className="uppercase text-xs tracking-widest mb-4">SERVICES</div>
            ...
            <div className="flex items-center flex-col">
              <div className="avatar">
                <div className="w-16 h-16 rounded-full overflow-hidden">
                  <Image 
                    src={service.testimonialImage || "/images/team/default-avatar.jpg"} 
              ...
              <div className="mt-2">
                <p className="font-semibold">{service.testimonialName || "JASON GARY"}</p>
                <p className="text-xs">{service.testimonialTitle || "CTO at ACME"}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {service.offerings.map((offering, index) => (
                <div 
                  key={index} 
                  className={`card shadow-lg ${offering.highlight ? 'bg-red-400 text-white' : 'bg-base-100'}`}
                >
                  <div className="card-body">
                    ...
                    <div className="flex justify-center my-6">
                      <div className="relative w-48 h-48">
                        <Image 
                          src={offering.image || `/images/services/placeholder.jpg`}
                          alt={offering.title} 
                          fill
                    ...
                    <ul className="space-y-2">
                      {offering.points.map((point, pointIndex) => (
                        <li key={pointIndex} className="flex items-start">
                          <svg 
                            className={`w-5 h-5 ${offering.highlight ? 'text-white' : 'text-primary'} mt-0.5 mr-2 flex-shrink-0`} 
                            fill="none" 
                            viewBox="0 0 24 24" 
                            stroke="currentColor"
                          >
      ...
      {service.comparison && (
        <section className="py-16 bg-base-200">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-12 text-center">{service.comparison.title}</h2>
              ...
              <table className="table w-full bg-white rounded-lg shadow-lg">
                ...
                <tbody>
                  {service.comparison.stages.map((stage, index) => (
                    <tr key={index} className={index % 2 === 1 ? 'bg-base-100' : ''}>
                      <td className="py-4 px-6 font-semibold">{stage.name}</td>
      ...
      {service.process && (
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-12 text-center">{service.process.title}</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="relative w-full h-96">
                  <Image 
                    src={service.process.image || "/images/services/process-diagram.jpg"}
                    alt="Our Process" 
                    fill
                    className="object-contain"
                  />
      ...
      <section className="py-16 bg-base-200">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-2 text-center">As a result, you get</h2>
          <p className="text-xl text-center mb-12 max-w-3xl mx-auto">
            {service.resultsHeadline || "An expertly designed solution tailored to your business goals"}
          </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 bg-base-200 rounded-lg p-8">
            <div className="w-full md:w-1/4">
              <div className="relative w-full h-48">
                <Image 
                  src={service.assessmentImage || "/images/services/assessment-graphic.jpg"} 
                  alt="Assessment" 
                  fill
                  className="object-contain"
                />
            ...
            <div className="w-full md:w-3/4">
              ...
              <p className="mb-6">Not sure if our {service.title} is the right fit for your needs? Take our quick assessment to find out which of our services would best address your current technical challenges.</p>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Schedule a free consultation to discuss how our {service.title} can help your business achieve its technical goals.
          </p>
          <div className="flex justify-center">
            <MeetingButton text="Book a Free Consultation" className="btn-lg btn-secondary" />
          </div>
        </div>
      </section>
    </PageLayout>
